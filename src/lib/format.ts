 ...
 *
 * @param targetDateStr - String tanggal target format YYYY-MM-DD, atau null bila belum diatur
 * @returns Jumlah hari tersisa; -1 bila tanggal belum diatur
 */
export function getDaysRemaining(targetDateStr: string | null): number {
  // Undangan draft belum punya tanggal acara. Kembalikan -1 agar badge
  // hitung mundur tidak ditampilkan.
